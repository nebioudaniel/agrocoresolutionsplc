    ...
    <main className="min-h-screen">
      ...
      <section className="py-24">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            <div className="bg-card p-8 lg:p-12 rounded-2xl shadow-xl text-center">
              ...
              <h3 className="text-2xl font-bold text-foreground mb-2">Hailu Meka</h3>
              <p className="text-primary font-medium mb-4">General Manager</p>
              <p className="text-muted-foreground mb-6 leading-relaxed">
                With extensive experience in agricultural consulting and regulatory affairs, 
                Hailu leads Agrocore Solutions with a vision of sustainable agriculture and 
                responsible business practices. His expertise spans agrochemical regulation, 
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                >
                  ...
                  <span>hailat1999@gmail.com</span>
                </a>
              </div>
            </div>
          </motion.div>
